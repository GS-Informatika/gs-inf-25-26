...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 08-exercises-cond-predicates) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
