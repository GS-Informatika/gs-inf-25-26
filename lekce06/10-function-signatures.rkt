...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 10-function-signatures) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; NOTE: v BSL můžeme použít signature formu
(: cute? ((enum "cat" "snake") -> Boolean))
(define (cute? pet)
  (cond [(string=? pet "cat") #t]
        [(string=? pet "snake") 6]))

(: VALUE Number)
(define VALUE 5)

; Která za běhu programu kontroluje
; pre-conditions vstupů a post-conditions
; výstupů funkcí a hodnot.
#;(cute? "cat")
#;(cute? "snake")
#;(cute? "dog")
#;(cute? 5)
