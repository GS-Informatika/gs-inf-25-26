...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname 21-recuring-auxiliary-functions) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; Design funkcí, které mají
