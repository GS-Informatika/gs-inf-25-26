...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 34-iteration) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; ------- CYKLY -------
...
;; funkcionálními loop strukturami.
...
#; (for/list ([i 10]) (add1 i))

#; (build-list 10 (lambda (x) (add1 x)))


#; (for/list ([num 5]
           [str (list "a" "b" "c" "d")]
           [x "abcd"])
     (string-append str x (number->string num)))
...
#; (for/and ([it (list 1 2 3 4)]) (number? it))
#; (for/or ([it (list 1 2 3 4)]) (< it 0))
#; (for/sum ([str (list "abc" "def" "abcdefgh")]) (string-length str))
...
#; (for/string ([char (list "a" "b" "c" "d" "e")])
     char)
